...
export class AudioManager {
  ...
  private musicPattern = [
    { freq: 523.25, duration: 0.22, type: 'triangle' as OscillatorType },
    { freq: 659.25, duration: 0.22, type: 'triangle' as OscillatorType },
    { freq: 783.99, duration: 0.22, type: 'triangle' as OscillatorType },
    { freq: 659.25, duration: 0.22, type: 'triangle' as OscillatorType },
    { freq: 587.33, duration: 0.22, type: 'triangle' as OscillatorType },
    { freq: 698.46, duration: 0.22, type: 'triangle' as OscillatorType },
    { freq: 880.0, duration: 0.3, type: 'triangle' as OscillatorType },
  ];

  private sounds: Record<string, AudioSound> = {
  ...
  private playTone({ freq, duration, type, volume = 0.2 }: AudioSound): void {
...
export function initAudioControls(audioManager: AudioManager): void {
  const unlock = (): void => {
    audioManager.unlock();
  };
