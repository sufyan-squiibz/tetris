...
export class AudioManager {
  ...
  private readonly musicPattern: AudioConfig[] = [
  ...
  private readonly sounds: Record<string, AudioConfig> = {
  ...
  private playTone({ freq, duration, type, volume = 0.2 }: AudioConfig): void {
  ...
  private startMusicLoop(): void {
    ...
    this.stopMusicLoop();
    this.musicTimeout = setTimeout(() => this.startMusicLoop(), patternDuration * 1000);
  }
}
