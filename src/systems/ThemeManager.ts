import { ITheme, PieceType } from '../types';
import { updatePieceColors } from '../game/TetrisPiece';
...
export class ThemeManager {
  ...
  applyTheme(): void {
    ...
    pieceTypes.forEach((piece) => {
      root.style.setProperty(`--piece-${piece}`, theme.pieces[piece]);
    });
    ...
    updatePieceColors(theme.pieces);
  }
