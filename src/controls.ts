...
const lastMoveTime: Record<string, number> = { left: 0, right: 0, down: 0 };
...
export function initSensitivityControl(showNotification: (msg: string) => void): void {
  const slider = document.getElementById('sensitivity-range') as HTMLInputElement | null;
