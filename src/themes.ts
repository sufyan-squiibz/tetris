...
export class ThemeManager {
    ...
    applyTheme(): void {
        ...
        if (container) {
            (container as HTMLElement).style.background = theme.background;
        }
    ...
    getPieceColor(pieceType: string): string {
        ...
        return pieces[pieceType as keyof typeof pieces] || '#ffffff';
    }
    ...
    getBoardBgNumber(): number {
        return this.hexToNumber(THEMES[this.currentTheme].boardBg);
    }

    getGridColorNumber(): number {
        return this.hexToNumber(THEMES[this.currentTheme].gridColor);
    }
}
